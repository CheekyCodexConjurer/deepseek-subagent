...
export class AntigravitySupervisor {
  ...
  private async finalizeTerminalStatus(
    ...
    const statusPayload: AntigravityAttemptStatus = {
      ...
      conversationId: effectiveParsed?.conversationId ?? this.manifest.conversationId ?? null,
      ...(effectiveParsed?.usage ? { usage: effectiveParsed.usage } : {}),
      ...(effectiveParsed?.durationSeconds !== undefined && effectiveParsed?.durationSeconds !== null ? { durationSeconds: effectiveParsed.durationSeconds } : {}),
      ...(effectiveParsed?.numTurns !== undefined && effectiveParsed?.numTurns !== null ? { numTurns: effectiveParsed.numTurns } : {}),
